...
### Update Road Map
* If the current release is the last in a quarter, ask team to update the [road map](https://github.com/eclipse-theia/theia/wiki/Roadmap) of the past quarter (close, remove or move items)
* If the current release is the second in a quarter, create [road map template](https://github.com/eclipse-theia/theia/wiki/Roadmap) for the next quarter, ask team to contribute to it and add it to the agenda of the Theia dev meeting
